...
| ACL 类型           | 编号范围        | 匹配依据                                         | 典型应用           |
| :----------------- | :-------------- | :----------------------------------------------- | :----------------- |
| **基本 ACL**       | **2000 ~ 2999** | 源 IP 地址                                       | 简单的网络访问限制 |
| **高级 ACL**       | **3000 ~ 3999** | 五元组（源 IP、目的 IP、源端口、目的端口、协议） | 精细化流量控制     |
| **二层 ACL**       | **4000 ~ 4999** | 源 MAC、目的 MAC、以太网帧类型                   | 基于 MAC 的过滤    |
| **用户自定义 ACL** | 5000 ~ 5999     | 自定义报文头偏移量                               | 特殊协议匹配       |
| **用户 ACL**       | 6000 ~ 6031     | 源 IP + 目的 IP                                  | 较少使用           |
